...
void HumanPlayer::takeTurn(Player& player) {

    humanReinforce(player);
    humanAttack(player);
    humanFortify(player);
...
void HumanPlayer::giveArmiesForTerritory(Player& player){
    //Todo: round down
...
bool HumanPlayer::reinforce(Player& player){
    string str;
    /******************
     * REINFORCE LOOP
     *****************/
...
void HumanPlayer::humanReinforce(Player& player){
    string txtline;
    bool answered = false;
...
void HumanPlayer::humanFortify(Player& player){
    int numOfArmies;
